/*
 * io.socket.io-java-client IOCallback.java
 *
...
public interface IOCallback {
	...
	/**
	 * On disconnect. Called when the io.socket disconnects and there are no further attempts to reconnect
	 */
	void onDisconnect();
	
	/**
	 * On connect. Called when the io.socket becomes ready so it is now able to receive data
	 */
	void onConnect();
	...
	/**
	 * On error. Called when io.socket is in an undefined state. No reconnect attempts will be made.
	 *
